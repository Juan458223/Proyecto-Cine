...
<head>
    ...
    <title>CINE FIRST - Iniciar Sesión</title>
</head>
<body class="flex flex-col md:flex-row h-screen w-full overflow-hidden">
    ...
    <div class="bg-black text-white h-full w-full md:w-[400px] flex flex-col justify-center p-9 ">
        <div class="mb-10 text-center flex flex-col items-center justify-center">
            <h2 class="text-6xl font-black text-[#E50914] uppercase tracking-wider leading-none" style="font-family: 'Bebas Neue', sans-serif; text-shadow: 3px 3px 5px rgba(0,0,0,0.8);">CINE FIRST</h2>
        </div>
        ...
        <!-- Recover Section -->
        <div class="hidden" id="recover-section">
