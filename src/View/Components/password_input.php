<?php
/**
 * Reusable helper to render password inputs with visibility toggle.
 * Keeps the structure consistent across the entire application.
 */
function render_password_input($id, $name, $label) {
    return "
    <div class='auth-input-group flex items-center w-full'>
        <div class='relative flex-grow'>
            <input type='password' name='{$name}' id='{$id}' class='auth-input-modern w-full' placeholder=' '>
